  ...
  return (
    <div name='home'>
      <div className="p-4 m-auto h-screen flex flex-col justify-between items-center md:flex-row sm:ml-24">
          <div className='mt-10'>
            <p className='text-light-white text-xl sm:text-4xl my-2 py-3'>Hi, I'm </p>
            <h1 className="text-6xl my-2 sm:text-7xl">Jayla Nicholas</h1>
        ...
        <div className="m-auto text-md sm:text-lg w-full sm:w-5/6 sm:mx-5 lg:mx-24">
          ...
          Coding also satisfies my inner builder, as I love the process of putting things together.
            Combining my love for computers with coding has been the perfect fit for me, and it's why
            I decided to pursue a career in programming. 
          </p>
        </div>
    </div>
  </div>
